    ...
    <div className="relative no-print" ref={dropdownRef}>
      ...
      >
        ...
        {shareCount !== null && shareCount > 0 && (
          <span className="ml-0.5 text-xs text-stone-400">{shareCount}</span>
        )}
      </button>

      {showDropdown && (
        <div className="absolute right-0 top-full mt-2 w-52 bg-white border border-stone-200 rounded-xl shadow-lg z-50 py-2">
          <button
            type="button"
            onClick={copyLink}
