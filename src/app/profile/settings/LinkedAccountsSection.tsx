...
export function LinkedAccountsSection({
  ...
  return (
    <div>
      <h3 className="text-lg font-semibold text-neutral-800">Linked Accounts</h3>
      ...
      <div className="mt-4 space-y-3">
        ...
        <div className="flex items-center justify-between rounded-lg border border-neutral-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-neutral-800">Google</p>
          ...
          {isGoogleLinked ? (
            <button
              ...
              className="inline-flex items-center gap-2 rounded-lg border border-neutral-300 bg-white px-3 py-1.5 text-sm font-medium text-neutral-600 hover:bg-neutral-50 disabled:opacity-50 transition-colors"
            >
              {unlinking === "google" ? (
        ...
        <div className="flex items-center justify-between rounded-lg border border-neutral-200 p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-medium text-neutral-800">Email & Password</p>
              <p className="text-xs text-neutral-500">
